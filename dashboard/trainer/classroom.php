...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'create_room') {
    ...
    $insert_stmt->bind_param("ssis", $room_id, $room_name, $user['user_id'], $room_key);
...
$rooms_stmt->bind_param("i", $user['user_id']);
$rooms_stmt->execute();
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 p-6 overflow-y-auto">
                <div class="mx-auto max-w-7xl">
                    ...
                    <!-- Page Header -->
                    <div class="mb-8">
                        <h1 class="mb-2 text-3xl font-bold text-gray-900">Trainer Classroom</h1>
                        <p class="text-gray-600">Host video conferences and conduct live teaching sessions</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        ...
                        <!-- Create/Join Room -->
                        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                            <h2 class="mb-6 text-xl font-semibold text-gray-900">Host or Join Conference</h2>

                            <!-- Create Room -->
                            <div class="mb-8">
                                <h3 class="mb-4 text-lg font-medium text-gray-900">Create Teaching Room</h3>
                                <form method="POST" class="space-y-4">
                                    ...
                                    <button type="submit"
                                        ...
                                        <i class="mr-2 fas fa-plus"></i>Create Teaching Room
                                    </button>
                                </form>
                            </div>
                        ...
                        <!-- My Rooms -->
                        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                            <h2 class="mb-6 text-xl font-semibold text-gray-900">My Teaching Rooms</h2>
                            ...
                            <div class="space-y-4">
                                ...
                                <?php else: ?>
                                    <div class="py-8 text-center text-gray-500">
                                        <i class="mb-2 text-3xl fas fa-chalkboard-teacher"></i>
                                        <p class="text-sm">No teaching rooms created yet</p>
                                        <p class="text-xs">Create your first teaching room to get started!</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <script>
            window.userData = {
                ...
                userName: '<?php echo htmlspecialchars(($user['first_name'] ?? 'Trainer') . ' ' . ($user['last_name'] ?? '')); ?>',
                userImage: '<?php echo $user['profile_image_url'] ?? 'https://ui-avatars.com/api/?name=' . urlencode(($user['first_name'] ?? 'Trainer') . ' ' . ($user['last_name'] ?? '')); ?>'
            };
