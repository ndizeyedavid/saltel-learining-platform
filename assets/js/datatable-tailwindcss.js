...
(function (factory) {
  ...
  $.extend(true, DataTable.ext.classes, {
    ...
    search: {
      input:
        "border placeholder-gray-400 ml-2 px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 bg-white",
    },
    length: {
      select:
        "border px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 bg-white",
    },
    processing: {
    ...
    thead: {
      ...
      cell: "px-3 py-4 text-gray-900 bg-gray-50 font-semibold text-left",
    },
    tbody: {
